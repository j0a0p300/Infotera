...
<html lang="pt-br">
    ...
    <body>
        <h2 id="logo">Infotravel</h2>
        <h3 id="inicioSessao"><a href="#">&rightarrow;] Iniciar Sessão</a></h3>
        <h1 id="frase">Os melhores Hotéis e Destinos para sua viagem</h1>
